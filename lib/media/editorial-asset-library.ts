...
export const editorialAssetLibrary = {
  ...
  "dtv-vs-education-lifestyle-hero": {
    id: "dtv-vs-education-lifestyle-hero",
    src: "/images/editorial/dtv-vs-education-visa-thailand-hero.jpg",
    alt: "Young foreign professional walking through a leafy university district in Thailand, representing the choice between a DTV Visa and an Education Visa.",
    objectPosition: "center 50%",
    subject:
      "Foreign professional with laptop walking through a leafy university district past language school signage",
    mood: "editorial, academic, lifestyle-led, warm, natural",
    orientation: "landscape",
    ...
    themes: ["education", "remote-work"],
    previousUsage: ["blog/dtv-vs-education-visa-thailand"],
  },
  "education-visa-work-rule-hero": {
    id: "education-visa-work-rule-hero",
    src: "/images/editorial/can-you-work-on-education-visa-thailand-hero.jpg",
    alt: "Young foreigner commuting on Bangkok's BTS Skytrain with a laptop and backpack, illustrating the question of whether working is allowed on an Education Visa in Thailand.",
    objectPosition: "center 50%",
    subject:
      "Young foreign commuter on Bangkok BTS Skytrain with laptop and backpack during morning rush",
    mood: "editorial, urban, professional, contemplative, natural light",
    orientation: "landscape",
    ...
    themes: ["education", "immigration", "bangkok-city-life"],
    previousUsage: ["blog/can-you-work-on-an-education-visa-in-thailand"],
  },
