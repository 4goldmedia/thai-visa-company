/**
 * “Moving should feel simple” — emotional transition band (homepage).
 */

export const movingSimpleSectionCopy = {
  eyebrow: "Moving should feel simple",
  titleLine1: "We make the complex,",
