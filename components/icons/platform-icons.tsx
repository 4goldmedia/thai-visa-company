...
/** LINE brand green  -  official app / brand icon color */
...
function PlatformIconFrame({
  className,
  size = "md",
  children,
}: PlatformIconFrameProps) {
  return (
    <svg
      className={cn(
        platformIconSizeClass[size],
...
/**
 * LINE brand icon  -  green speech bubble + white wordmark (official geometry).
 * Source: Simple Icons / LINE brand mark (24×24), used unmodified per layer colors.
 * @see https://line.me/en/logo
 */
const LINE_BUBBLE_PATH =
  "M24 10.314C24 4.943 18.615.572 12 .572S0 4.943 0 10.314c0 4.811 4.27 8.842 10.035 9.608.391.082.923.258 1.058.59.12.301.079.766.038 1.08l-.164 1.02c-.045.301-.24 1.186 1.049.645 1.291-.539 6.916-4.078 9.436-6.975C23.176 14.393 24 12.458 24 10.314"
...
function LineIcon({
  ...
  return (
    <PlatformIconFrame className={className} size={size}>
      ...
      <path fill="#FFFFFF" d={LINE_WORDMARK_PATH} />
    </PlatformIconFrame>
  )
}

/**
 * WhatsApp brand mark  -  single-path official geometry (24×24).
 */
const WHATSAPP_PATH =
